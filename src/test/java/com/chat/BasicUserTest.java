...
public class BasicUserTest extends Assert {

    public User createUser(String name, String password, Boolean online) {
        User user = new User();
    ...
    public boolean equalsUsers(User firstUser, User secondUser) {
        boolean result = true;
